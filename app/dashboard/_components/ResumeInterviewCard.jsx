...
const ResumeInterviewCard = () => {
  ...
  return (
    <motion.div
      ...
      className="group border-2 border-dashed border-border rounded-2xl p-8 flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-primary/60 hover:bg-accent transition-all duration-300"
    >
      <div className="relative">
        ...
        <div className="relative h-12 w-12 rounded-xl bg-accent group-hover:bg-primary/10 flex items-center justify-center transition-colors duration-300">
          <FileText className="h-6 w-6 text-muted-foreground group-hover:text-primary transition-colors duration-300" />
        </div>
      </div>
